...
$trainJsonl = "data/sft/chat7b_pht_correction_mix/train.jsonl"
$valJsonl = "data/sft/chat7b_pht_correction_mix/val.jsonl"
$previewJson = "data/sft/chat7b_pht_correction_mix/preview.json"
$configPath = "configs/sft.chat7b.pht.correction.mix.yaml"
$runName = "room_chat_qwen25_7b_instruct_pht_v1_correction_mix_v1"
