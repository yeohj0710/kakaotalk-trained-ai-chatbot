...
$configPath = "configs/sft.chat7b.pht.answer_refine.yaml"
$runName = "room_chat_qwen25_7b_instruct_pht_v1_answer_refine"
$initAdapter = "checkpoints_lora/room_chat_qwen25_7b_instruct_pht_v1_refine/adapter_best"

$requiredDataFiles = @(
  "data/sft/chat7b_pht_answer_refine/train.jsonl",
  "data/sft/chat7b_pht_answer_refine/val.jsonl",
  "data/sft/chat7b_pht_answer_refine/preview.json",
  "data/sft/chat7b_pht_answer_refine/stats.json"
)
