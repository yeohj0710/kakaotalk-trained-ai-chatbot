...
$configPath = "configs/sft.chat7b.pht.closer_refine.yaml"
$runName = "room_chat_qwen25_7b_instruct_pht_v1_closer_refine"
$initAdapter = "checkpoints_lora/room_chat_qwen25_7b_instruct_pht_v1_direct_refine/adapter_best"

$requiredDataFiles = @(
  "data/sft/chat7b_pht_closer_refine/train.jsonl",
  "data/sft/chat7b_pht_closer_refine/val.jsonl",
  "data/sft/chat7b_pht_closer_refine/preview.json",
  "data/sft/chat7b_pht_closer_refine/stats.json"
)
