...
DEFAULT_SFT_CONFIG: ConfigDict = {
    ...
    "data": {
        ...
        "training_mode": "next_turn_all_speakers",
        "target_speakers": [],
        "project_user_names": False,
        "min_other_speaker_turns": 0,
        "require_last_context_from_other_speaker": False,
        "require_last_context_reply_prompt": False,
